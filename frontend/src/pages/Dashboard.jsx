    ...
    <div className="dashboard">
      ...
      <section className="dashboard-stats">
        <div className="stat-card">
          <span> Open tasks </span> <strong> 0 </strong>  
          <small> Tasks waiting for Executors </small>  
        </div>  
        <div className="stat-card">
          <span> Active tasks </span> <strong> 0 </strong>  
          <small> Currently being executed </small>  
        </div>  
        <div className="stat-card">
          <span> Completed </span> <strong> 0 </strong>  
          <small> Successfully completed </small>  
        </div>  
        <div className="stat-card">
          <span> Earnings </span> <strong> ₹0 </strong>  
      ...
      <section className="dashboard-section">
        ...
        <div className="action-grid">
          <Link to="/tasks/create" className="action-card">
            <span className="action-icon"> → </span> <h3> Create a task </h3>  
            <p> Tell an Executor what you need done. </p>  
          </Link>  
          <Link to="/find-tasks" className="action-card">
            <span className="action-icon"> ⌕ </span> <h3> Find tasks </h3>  
